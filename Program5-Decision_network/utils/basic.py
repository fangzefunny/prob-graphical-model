...
class node:
    '''Class that defines nodes in a ID.
    
    Slightly modified based on my own implementation
    in project1-3
    '''
    def __init__( self, name, states, node_type):
        # basic info 
        self.name           = name
        self.node_type      = node_type  # 'value', 'decision', or 'chance'
        self.cpt            = None  
        self.states         = states 
