...
class belief_prop:
    ...
    def fix_evidence( self, evid={}, utility=None):
        '''
        input the evidence, and initiate the cached pi_msg and lambda_msg
        '''
        for evid_name in evid.keys():
            evid_state = evid[ evid_name]
        ...
        if utility:
            node_list.pop( node_list.index(utility))
    ...
    def inference( self, evidence, mode = 'sum-product', utility=None):
        '''
        ...
        self.fix_evidence( evidence, utility)
